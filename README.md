...
| `cursor`              | `boolean` | Enables/disables the terminal cursor on the Typewriter animation. | `true`                                        | [DEMO](https://svelte.dev/repl/6008b5aaff6f46e5909c63e795a19f5a)                |
| `cursorColor`              | `string` | Allows you to pass any valid color name, hex code, rgb/rgba valid values to change the cursor color | `black`                                        |                 |
| `cursorWidth`              | `string` | Set cursor width using `ch` units. | `1ch`                                        |                 |
